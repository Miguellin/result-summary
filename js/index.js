...
function randomValues() {
    ...
    values.forEach((values, index) => {
        switch (index) {
            case 0:
                reaction.innerText = values + ' / 100';
                break;
            case 1:
                memory.innerText = values + ' / 100';
                break;
            case 2:
                verbal.innerText = values + ' / 100';
                break;
            case 3:
                visual.innerText = values + ' / 100';
                break;
                default:
                    'Todo mal'
        }
    ...
    if (result >= 75) {
        ...
        paragraph.innerText = 'Felicidades! Eres una persona con una excelente memoria, reaccion, verbal y visual. Sigue asi!';
    ...
    if (result <= 74 && result >= 43)  {
        ...
        paragraph.innerText = 'Estas en el rango normal de persona';
